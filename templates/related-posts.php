...
// Related posts
function bootscore_related_posts_action() {
  
  // First check if it's a single post
  if (!is_single()) {
    return;
  }
  ...
  if ($related_cats_post->have_posts()) :
    ...
    <div class="related-posts border-top mb-3">
      ...
      <div class="bs-swiper-wrapper bs-swiper-columns position-relative px-lg-5">
        <div class="cards swiper-container swiper position-static">

          <div class="swiper bs-swiper-container" 
            data-swiper-breakpoints='{"0":{"slidesPerView":1},"576":{"slidesPerView":1},"768":{"slidesPerView":2},"992":{"slidesPerView":3},"1200":{"slidesPerView":4},"1400":{"slidesPerView":4}}'
            data-swiper-loop="true" 
            data-swiper-autoplay="false" 
            data-swiper-delay="4000" 
            data-swiper-spacebetween="24" 
          ...
          >
            ...
            <div class="swiper-wrapper">
              ...
              ?>
                ...
                <article class="swiper-slide card h-auto mb-5">
...
// Hook directly to bootscore_before_pagination
add_action('bootscore_before_pagination', 'bootscore_related_posts_action');
